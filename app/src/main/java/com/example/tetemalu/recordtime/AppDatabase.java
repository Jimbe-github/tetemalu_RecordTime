              ...
              .addCallback(new Callback() {
                ...
                public void onCreate(SupportSQLiteDatabase db) {
                  ...
                  db.execSQL("INSERT INTO TimeTable (title, datetime, done) VALUES " +
                          "('テスト1', '2024-02-18 10:20:30', 1)," +
                          "('テスト2', '2024-02-19 11:21:31', 0)," +
                          "('テスト3', '2024-02-19 22:32:42', 0)"
                  );
                  /* DAO を使って出来るという海外の記事を見たが例外が発生してしまった
                  TimeTableDao dao = INSTANCE.getTimeTableDao();
                  dao.insertAll(
                          new TimeTableEntity("テスト1", LocalDateTime.of(2024,2,18,10,20,30), true),
                          new TimeTableEntity("テスト2", LocalDateTime.of(2024,2,19,11,21,31), false),
                          new TimeTableEntity("テスト3", LocalDateTime.of(2024,2,19,22,32,42), false)
                  );
                  */
                }
              })
